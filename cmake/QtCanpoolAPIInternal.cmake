...
if (APPLE)
  ...
  set(_IDE_HEADER_INSTALL_PATH "${_IDE_DATA_PATH}/Headers/qtproject")
...
elseif(WIN32)
  ...
  set(_IDE_LIBRARY_PATH "${_IDE_LIBRARY_BASE_PATH}/qtproject")
  set(_IDE_PLUGIN_PATH "${_IDE_LIBRARY_BASE_PATH}/qtproject/plugins")
  set(_IDE_LIBEXEC_PATH "bin")
  set(_IDE_DATA_PATH "share/qtproject")
  set(_IDE_DOC_PATH "share/doc/qtproject")
  set(_IDE_BIN_PATH "bin")

  set(_IDE_HEADER_INSTALL_PATH "include/qtproject")
  ...
  set(_IDE_LIBRARY_PATH "${_IDE_LIBRARY_BASE_PATH}/qtproject")
  set(_IDE_PLUGIN_PATH "${_IDE_LIBRARY_BASE_PATH}/qtproject/plugins")
  set(_IDE_LIBEXEC_PATH "${CMAKE_INSTALL_LIBEXECDIR}/qtproject")
  set(_IDE_DATA_PATH "${CMAKE_INSTALL_DATAROOTDIR}/qtproject")
  set(_IDE_DOC_PATH "${CMAKE_INSTALL_DATAROOTDIR}/doc/qtproject")
    ...
    if (NOT ${target_type} STREQUAL "OBJECT_LIBRARY")
      ...
      if (NOT TARGET ${PROJECT_NAME}PchGui AND NOT TARGET ${PROJECT_NAME}PchConsole)
        ...
        _add_pch_target(${PROJECT_NAME}PchGui
          "${QtCanpool_SOURCE_DIR}/src/shared/qtcanpool_gui_pch.h" Qt5::Widgets)
        _add_pch_target(${PROJECT_NAME}PchConsole
          "${QtCanpool_SOURCE_DIR}/src/shared/qtcanpool_pch.h" Qt5::Core)
      endif()
