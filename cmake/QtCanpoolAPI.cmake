...
include(${CMAKE_CURRENT_LIST_DIR}/QtCanpoolAPIInternal.cmake)
...
function(qtc_output_binary_dir varName)
  if (QTC_MERGE_BINARY_DIR)
    set(${varName} ${QtCanpool_BINARY_DIR} PARENT_SCOPE)
  else()
...
function(add_qtc_plugin target_name)
  ...
  foreach(i IN LISTS _DEP_PLUGINS)
    if (i MATCHES "^QtCanpool::")
      set(_v ${QTPROJECT_VERSION})
      string(REPLACE "QtCanpool::" "" i ${i})
    else()
...
function(qtc_add_public_header header)
  ...
  qtc_source_dir(qtcanpool_source_dir)
  get_filename_component(source_dir ${header} DIRECTORY)
  file(RELATIVE_PATH include_dir_relative_path ${qtcanpool_source_dir} ${source_dir})
