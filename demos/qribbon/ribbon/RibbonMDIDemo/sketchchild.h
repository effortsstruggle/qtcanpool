...
/* SketchChild */
class SketchChild : public QAbstractScrollArea, public ChildInterface
{
    Q_OBJECT
...
public:
    ...
    virtual void buildUserInterface(QRibbon::RibbonBar *rib, QStatusBar *statusBar, QRibbon::RibbonPage *pageHome);
    virtual void removeUserInterface(QRibbon::RibbonBar *rib, QStatusBar *statusBar, QRibbon::RibbonPage *pageHome);
...
protected:   // section of the ribbon
    ...
    void fillRibbonSketch(QRibbon::RibbonBar *rib);
    void clearRibbonSketch(QRibbon::RibbonBar *rib);

    void createGeometryGroup(QRibbon::RibbonGroup *geomGroup);
...
protected:
    ...
    QRibbon::RibbonGroup *geomGridObject;
    QRibbon::RibbonGroup *geomEditObject;
