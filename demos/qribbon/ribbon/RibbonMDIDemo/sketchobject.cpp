...
/* GeomObject */
GeomObject::GeomObject() : m_bVisible(false), m_bSelect(false), m_bHighlight(false)
{
}

GeomObject::GeomObject(const GeomObject &other) : m_bVisible(other.m_bVisible), m_bSelect(false), m_bHighlight(false)
{
}
...
/* GeomGrid */
GeomGrid::GeomGrid() : m_width(0), m_height(0), m_step(5.0)
{
}

GeomGrid::GeomGrid(const GeomGrid &other)
    : GeomObject(other), m_width(other.m_width), m_height(other.m_height), m_step(other.m_step)
{
}
...
GeomLine::GeomLine(const QPointF &p1, const QPointF &p2) : m_point1(p1), m_point2(p2)
{
}
...
GeomLine::GeomLine(const GeomLine &other) : GeomObject(other), m_point1(other.m_point1), m_point2(other.m_point2)
{
}
...
double GeomLine::distance(const QPointF &p) const
{
    ...
    return dist;
    /* for direct
        double numerator = (m_point1.y()-m_point2.y())*p.x() + (m_point2.x()-m_point1.x())*p.y() +
       (m_point1.x()*m_point2.y()-m_point2.x()*m_point1.y()); double denominator =
       sqrt(pow(m_point2.x()-m_point1.x(), 2.0) + pow(m_point2.y()-m_point1.y(), 2.0)); double dis =
       fabs(numerator)/denominator; return dis;
    */
}

/* GeomCircle */
GeomCircle::GeomCircle() : m_center(0.0, 0.0), m_radius(0.0)
{
}

GeomCircle::GeomCircle(const GeomCircle &other) : GeomObject(other), m_center(other.m_center), m_radius(other.m_radius)
{
}
...
GeomRectangle::GeomRectangle(const GeomRectangle &other)
    : GeomObject(other), m_point1(other.m_point1), m_point2(other.m_point2)
{
}
