...
{
    setStyleTheme(OfficeStyle::OfficeWhite);
...
{
    QRibbon::RibbonGroup *group = page->addGroup(tr("Large Buttons"));
...
{
    QRibbon::RibbonGroup *group = page->addGroup(tr("Small Buttons"));
    RibbonToolBarControl *toolBar = new RibbonToolBarControl(group);
...
{
    QRibbon::RibbonGroup *group = page->addGroup(tr("Large+Small Buttons"));
