...
void MainWindow::createRibbon()
{
    ...
    group->addAction(QIcon(":/shared/res/logo.png"), tr("Button"), Qt::ToolButtonTextUnderIcon);
    ...
    group->addAction(QIcon(":/shared/res/logo.png"), tr("Button 1"), Qt::ToolButtonTextUnderIcon);
    ...
    group->addAction(QIcon(":/shared/res/logo.png"), tr("Button 2"), Qt::ToolButtonTextUnderIcon);
