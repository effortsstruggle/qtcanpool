...
QWaitProgressBar::QWaitProgressBar(WaitType type, QWidget *parent)
    : QWidget(parent)
...
void QWaitProgressBar::setForeColor(QColor color)
{
...
void QWaitProgressBar::setBackColor(QColor color)
{
...
void QWaitProgressBar::setClockwiseRotate(bool clockwise)
{
...
void QWaitProgressBar::setRotateDelta(int delta)
{
...
void QWaitProgressBar::paintEvent(QPaintEvent *)
{
    QPainter p(this);
...
void QWaitProgressBar::drawLineWait(QPainter &p)
{
    p.save();
    p.setPen(Qt::NoPen);
...
void QWaitProgressBar::drawCircleWait(QPainter &p)
{
    p.save();
    p.setPen(Qt::NoPen);
    QColor color = m_foreColor;
...
void QWaitProgressBar::drawDonutWait(QPainter &p)
{
    int outRadius = 50;
    int inRadius = 30;
...
void QWaitProgressBar::drawPieWait(QPainter &p)
{
    p.save();
    p.setPen(Qt::NoPen);
    p.setBrush(QBrush(m_backColor));
...
void QWaitProgressBar::drawTaiChiWait(QPainter &p)
{
    p.save();
    p.setPen(Qt::NoPen);
    p.setBrush(QBrush(m_foreColor));
...
void QWaitProgressBar::drawPetalWait(QPainter &p)
{
    p.save();
    p.setPen(Qt::NoPen);
    QColor color = m_foreColor;
...
void QWaitProgressBar::drawBearingWait(QPainter &p)
{
...
void QWaitProgressBar::drawBubbleWait(QPainter &p)
{
    p.save();
    p.setPen(Qt::NoPen);
    QColor color = m_foreColor;
...
void QWaitProgressBar::drawInfiniteWait(QPainter &p)
{
    p.save();
